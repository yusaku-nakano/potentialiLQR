...
class Cost(abc.ABC):
    ...
    def quadraticize():
        """
        Compute the Jacobians and Hessians of the operating point with respect to the state and controls
        """
        pass
...
class TrackingCost(Cost):
    ...
    _id = 0
    """
    _id keeps track of the number of instances created.
    If no id is provided, the instance is assigned the current value of _id, and then _id is incremented by 1.
    """
